 ...
 * @description
 *
 * Priority Slider Block Class
 *
 */
export default class PrioritySlider {
	...
	constructor() {
		...
		const glides = document.querySelectorAll( '.priority-slider-block .glide' );
